...
#define USE_MAP
#define USE_ENVMAP
#define ENVMAP_TYPE_CUBE_REPEAT
...
// BEGIN uv2_pars_fragment

#if defined( USE_LIGHTMAP ) || defined( USE_AOMAP )
	varying vec2 vUv2;
#endif

// END uv2_pars_fragment
// BEGIN map_pars_fragment
...
// BEGIN emissivemap_pars_fragment
...
// END bsdfs
// BEGIN cube_uv_reflection_fragment
...
// BEGIN lights_pars_maps
	...
	vec3 getLightProbeIndirectRadiance( const in GeometricContext geometry, const in float blinnShininessExponent, const in int maxMIPLevel ) {
		...
		#elif defined( ENVMAP_TYPE_CUBE_REPEAT )
			vec4 envMapColor = vec4( 1.0, 0.0, 0.0, 1.0 );
...
// END lights_pars_maps
// BEGIN lights_physical_pars_fragment
...
// BEGIN roughnessmap_pars_fragment
...
// BEGIN metalnessmap_pars_fragment
...
// BEGIN logdepthbuf_pars_fragment
...
// BEGIN clipping_planes_pars_fragment
...
void main() {
// BEGIN clipping_planes_fragment
...
// BEGIN lights_physical_fragment
...
// BEGIN encodings_fragment

  gl_FragColor = linearToOutputTexel( gl_FragColor );


// END encodings_fragment
// BEGIN fog_fragment
...
// END fog_fragment
// BEGIN premultiplied_alpha_fragment
